...
2. Use the SSH URL for the forked repo to clone it to your local system:
    ...
    ```
    git clone git@github.rackspace.com:my-github-username/docs-SDP.git
    ```
...
10. Create a pull request (PR) to the upstream repo for your branch:
    ...
    a. Go to ``https://https://github.com/rackerlabs/docs-SDP``.

    b. Click the **Create pull request** button.

    c. If this PR is related to an outstanding
      [GitHub issue](https://https://github.com/rackerlabs/docs-SDP/issues), include a link to that GitHub issue in the comment.
